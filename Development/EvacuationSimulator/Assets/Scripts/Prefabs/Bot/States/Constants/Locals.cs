...
namespace Assets.Scripts.Prefabs.Bot.States.Constants
{
    public static class Locals
    {
        ...
        public static readonly int OBSERVATION_NUMBER_OF_RAYS = 23;
        ...
        public static readonly float OBSERVATION_START_ANGLE_OF_RAYS = -110;
        ...
        public static readonly double DQN_MINIMUM_EXPLORATION = 0.1;
        public static readonly double DQN_EXPLORATION_DECAY = 0.997;
